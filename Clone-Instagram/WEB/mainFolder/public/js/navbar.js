...
const navbarDirect = document.querySelector(".DM");
const navbarSearch = document.querySelector(".compass");
const navbarFeed = document.querySelector(".feed");
const logoBtn = document.querySelector(".logo");

let homeIsFull = false;
...
const homeHandler = () => {
  if (!homeIsFull) {
    navbarHome.childNodes[1].setAttribute(
      "d",
    ...
    navbarDirect.childNodes[1].setAttribute(
      "d",
    ...
    navbarSearch.childNodes[1].setAttribute(
      "d",
    ...
    navbarFeed.childNodes[1].setAttribute(
      "d",
...
const directHandler = () => {
  if (!directIsFull) {
    navbarDirect.firstElementChild.setAttribute(
      "d",
...
navbarDirect.addEventListener("click", () => {
  directHandler();
});
...
navbarFeed.addEventListener("click", () => {
  feedHandler();
});
